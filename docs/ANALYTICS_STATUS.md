...
- **Content**:
  ...
  - Justification: Free tier, industry standard, powerful features, GDPR consent mode
...
Once you have your Measurement ID, just replace `"G-XXXXXXXXXX"` in `src/_data/site.json` with your actual ID and rebuild!
